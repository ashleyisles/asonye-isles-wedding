  ...
  return (
    <div className="grid grid-cols-2 h-full">
      ...
      <div className="bg-black bg-opacity-25">
        {/* <div className="bg-cover bg-center bg-no-repeat h-full w-full" style={{ backgroundImage: 'url(https://images.unsplash.com/flagged/photo-1556067127-2afbd0feabbc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2550&q=80' }}> */}
      {/* </div> */}
      </div>
    </div>
  )
